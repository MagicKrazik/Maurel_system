    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_type', models.CharField(choices=[('mantenimiento', 'Mantenimiento y Cotizaciones'), ('pagos_mantenimiento', 'Pagos de Mantenimiento'), ('gastos_pasivos', 'Gastos y Pasivos'), ('minutas', 'Minutas'), ('reglamentos', 'Reglamentos'), ('otros', 'Otros')], max_length=50)),
                ('file', models.FileField(upload_to='documents/')),
                ('upload_date', models.DateTimeField(auto_now_add=True)),
                ('date', models.DateField()),
                ('related_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='related_documents', to=settings.AUTH_USER_MODEL)),
